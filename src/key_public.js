...
*/
function PublicKey(Q, pubkey_prefix = 'VEX') {
    if(typeof Q === 'string') {
    ...
    */
    function toString(pubkey_prefix = 'VEX') {
...
/**
  ...
  @param {string} [pubkey_prefix = 'VEX']
*/
PublicKey.isValid = function(pubkey, pubkey_prefix = 'VEX') {
    try {
...
*/
PublicKey.fromString = function(public_key, pubkey_prefix = 'VEX') {
    try {
...
/**
    ...
    @return PublicKey
*/
PublicKey.fromStringOrThrow = function(public_key, pubkey_prefix = 'VEX') {

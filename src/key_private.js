...
/**
    ...
    @arg {string} privateStr VexChain or Wallet Import Format (wif) -- a secret
*/
...
function unitTest() {
  ...
  assert.equal(pub.toString(), 'VEX859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2HqhToVM', pubError)
